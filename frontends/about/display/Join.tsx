                ...
                <section class="join block_default">
                    ...
                    <ul class="list">
                        <li class="list_item text">Заявление о вступлении в РАКИБ (скачать шаблон в формате
                            <a
                                href="/contents/docs/zayavlenieFL.pdf"
                                class="link"
                                target="_blank"
                            >
                                .pdf
                        ...
                        <li class="list_item text">Согласие на обработку персональных данных (скачать шаблон в формате
                            <a
                                href="/contents/docs/racibSoglasie.pdf"
                                class="link"
                                target="_blank"
                            >
                                .pdf
                    ...
                    <ul class="list">
                        <li class="list_item text">Заявление о вступлении в РАКИБ (скачать в формате
                            <a
                                href="/contents/docs/zayavlenieUL.pdf"
                                class="link"
                                target="_blank"
                            >
                                .pdf
                    ...
                    <p class="text text join_text">Все документы нужно отправить по вашей электронной почте, с которой вы проходили регистрацию на нашу почту <span class="text_bold">info@racib.com</span>. Пожалуйста, прикрепите все необходимые документы одним письмом, ничего не забудьте.</p>

                    <p class="text join_text">Как правило, скан-копию заполненных и подписанных необходимых документов нужно отправить не позднее 7 (семи) календарных дней на адрес электронной почты <span class="text_bold">info@racib.com</span> в формате PDF, одним письмом.</p>
                    ...
                    <div class="join_footer">
                        ...
                        <ul>
                            <li class="text">
                                <a href="/contents/docs/zayavlenieFL.pdf" class="link" target="_blank">
                                    Заявление на вступлление.pdf
                                </a>
                            </li>
                            <li class="text">
                                <a href="/contents/docs/racibSoglasie.pdf" class="link" target="_blank">Согласие на обработку персональных данных.pdf</a>
                            </li>
                            <li class="text">
                                <a href="/contents/docs/informatsionnoePismo.pdf" class="link" target="_blank">
                                    Документ об уплате членского взноса.pdf</a>
                            </li>
                            <li class="text">
                                <a href="/contents/docs/zayavlenieUL.pdf" class="link" target="_blank">Заявление о вступлении в РАКИБ (для юридических лиц).pdf</a>
                            </li>
                        </ul>
                    ...
                    <div class="join_btn">
                        <a href="/form" class="btn_link btn_link_dark" onclick={Fn.link}>Подать заявку</a>
                    </div>
